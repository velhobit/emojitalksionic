...
import { IonContent, IonHeader, IonTitle, IonToolbar, IonGrid, IonRow, IonCol, IonButton, IonText, ToastController, ModalController, IonInput, IonPopover } from '@ionic/angular/standalone';
...
@Component({
  ...
  standalone: true,
 imports: [IonHeader, IonToolbar, IonTitle, IonContent, IonGrid, IonRow, IonCol, CommonModule, IonButton, IonInput, IonPopover, FormsModule]
})
